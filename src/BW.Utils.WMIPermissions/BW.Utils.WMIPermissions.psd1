#
# Module manifest for module 'BW.Utils.WMIPermissions'
#
...
RootModule = 'BW.Utils.WMIPermissions.psm1'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ProjectUri = 'https://github.com/realslacker/BW.Utils.WMIPermissions'
